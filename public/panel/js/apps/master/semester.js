var table = NioApp.DataTable('#dt-table', {
    ...
    columns: [
        ...
        {data: 'periode_mulai', name: 's.periode_mulai'},
        {data: 'periode_selesai', name: 's.periode_selesai'},
...
function hapus(kode) {
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: '/master/delete-semester/'+kode,
                dataType: 'JSON',
